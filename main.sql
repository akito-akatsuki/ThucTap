-- =====================================================
-- FULL SCHEMA BACKUP
-- Includes: tables, foreign keys, functions, triggers
-- No data included
-- =====================================================
...
-- Create inventory row when new product is inserted
...
-- Update inventory stock after stock movements
...
-- Auto-create user in public.users after auth
